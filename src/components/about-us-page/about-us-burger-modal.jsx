...
import { useAboutUsModal } from "../../context/about-us-modal-context";
import { useNavigate } from "react-router-dom";

function AboutUsBurgerModal() {
  const { isOpen, setIsOpen } = useAboutUsModal();
...
export default AboutUsBurgerModal;
